...
#            phosystlabels.append("MvaLinearSyst%s01sigma" % direction)
            ...
            variablesToUse.append("MuonIDWeight%s01sigma[1,-999999.,999999.] := getExtraObjWeight(\"muonsMuon%sIDWeight%s01sigma\")" % (direction,str(customize.metaConditions["MUON_ID"]),direction))
            variablesToUse.append("ElectronIDWeight%s01sigma[1,-999999.,999999.] := getExtraObjWeight(\"electronsElectronIDWeight%s01sigma\")" % (direction,direction))
            variablesToUse.append("ElectronRecoWeight%s01sigma[1,-999999.,999999.] := getExtraObjWeight(\"electronsElectronRecoWeight%s01sigma\")" % (direction,direction))
            variablesToUse.append("MuonIsoWeight%s01sigma[1,-999999.,999999.] := getExtraObjWeight(\"muonsMuon%sISOWeight%s01sigma\")" % (direction,str(customize.metaConditions['MUON_ISO']),direction))
